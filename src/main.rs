...
#[cfg(feature = "tui")]
pub(crate) use build::{BuildCancelled, BuildControl, CancelOutcome, LineKind};
use build::{Frontend, ShadowReport, install_and_commit};
use clap::{Parser, Subcommand};
use hints::{pasteable_prefix, unpin_hint};
use install_warnings::duplicate_install_warnings;
...
#[cfg(feature = "tui")]
pub(crate) use tui_ops::{
    AuthorizationRefused, BatchCancel, BatchControl, BatchStep, InstallBatchEnd, MemberOutcome,
    PlannedUpdate, TuiRemove, TuiSetPinned, UpdatePlan, tui_downgrade_one, tui_install_batch,
    tui_install_one, tui_migrate_one, tui_reinstall_one, tui_reinstall_plan, tui_reinstall_sweep,
    tui_remove_one, tui_set_pinned, tui_update_one, tui_update_plan, tui_update_sweep,
    tui_update_sweep_check,
};
