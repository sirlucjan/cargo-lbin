...
fn draw_help(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let lines = [
        ...
        "Every build workflow runs here. A privileged remove or pin still",
        "hands the terminal over, and a build may too before it starts,",
        "when the first privileged lock cannot be prepared quietly.",
        "",
